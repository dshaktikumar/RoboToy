...
The source files, the test data and any test code. Ideally we'd prefer a link to your repository on github, however we can also accept submissions to both [recruitment](mailto:kanak.pandit@insigniafinancial.com.au) and [engineering](mailto:itengineering@insigniafinancial.com.au). When you apply through seek there will be a space to include the github link.
